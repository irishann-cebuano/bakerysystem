...
<div class="sidebar">
    <ul>
        ...
        <li><a href="/bakery_records_system/sidebars/expense_categories.php">🏷️ Expense Categories</a></li>
...
<section class="dashboard" id="dashboardCards"></section>

<script src="/bakery_records_system/js/jquery-4.0.0.min.js"></script>
<script src="/bakery_records_system/js/dashboard.js" defer></script>
